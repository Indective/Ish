...
fix issue with exit command, as right now it is needed to run this command the same number times the command execution for other commands failed throught the shell session.            done, working
